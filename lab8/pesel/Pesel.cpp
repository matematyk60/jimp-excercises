...
namespace academia{
    ...
    bool Pesel::PeselChecksum(const char *input) {
        int suma = 0;
        suma = 9*((int)input[0]-48)+7*((int)input[1]-48)+3*((int)input[2]-48)+1*((int)input[3]-48)+
               9*((int)input[4]-48)+7*((int)input[5]-48)+3*((int)input[6]-48)+1*((int)input[7]-48)+9*((int)input[8]-48)+7*((int)input[9]-48);
