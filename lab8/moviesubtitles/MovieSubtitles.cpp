...
namespace moviesubs{
    ...
    ostream *SubRipSubtitles::ParseLine(int delay, int fps, istream *input, ostream *output, int line_number) {
        ...
        if(new_frame1 < 0 || new_frame2 < 0){
            throw NegativeFrameAfterShift(GetString2OfNumber(frame1/3600000) + ":" + GetString2OfNumber((frame1-(frame1/3600000)*3600000)/60000)
                                          + ":" + GetString2OfNumber((frame1-((frame1-(frame1/3600000)*3600000)/60000)*60000)/1000) + "," +
                                          GetString3OfNumber(frame1%1000) +
                                          " --> " + GetString2OfNumber(frame2/3600000) + ":" + GetString2OfNumber((frame2-(frame2/3600000)*3600000)/60000)
                                          + ":" + GetString2OfNumber((frame2-((frame2-(frame2/3600000)*3600000)/60000)*60000)/1000) + "," +
                                          GetString3OfNumber(frame2%1000), line_number );
        }

        if(new_frame1 >= new_frame2){
            throw SubtitleEndBeforeStart( GetString2OfNumber(frame1/3600000) + ":" + GetString2OfNumber((frame1-(frame1/3600000)*3600000)/60000)
                                          + ":" + GetString2OfNumber((frame1-((frame1-(frame1/3600000)*3600000)/60000)*60000)/1000) + "," +
                                          GetString3OfNumber(frame1%1000) +
                                          " --> " + GetString2OfNumber(frame2/3600000) + ":" + GetString2OfNumber((frame2-(frame2/3600000)*3600000)/60000)
                                          + ":" + GetString2OfNumber((frame2-((frame2-(frame2/3600000)*3600000)/60000)*60000)/1000) + "," +
        ...
        *output << line + "\n" + GetString2OfNumber(new_frame1/3600000) + ":" + GetString2OfNumber((new_frame1-(new_frame1/3600000)*3600000)/60000)
                + ":" + GetString2OfNumber((new_frame1-((new_frame1-(new_frame1/3600000)*3600000)/60000)*60000)/1000) + "," +
                GetString3OfNumber(new_frame1%1000) +
                " --> " + GetString2OfNumber(new_frame2/3600000) + ":" + GetString2OfNumber((new_frame2-(new_frame2/3600000)*3600000)/60000)
